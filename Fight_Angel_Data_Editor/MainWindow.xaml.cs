...
namespace Fight_Angel_Data_Editor
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            bool success = false;
            if (bud_scaling_enabled.IsChecked == true)
            {
                success = run(manipulate_breast_position_up_and_down_scaling);
            }
            if (success)
            {
                run(manipulate_breast_max_scaling);
            }
            e.Handled = true;
        }

        private bool run(Func<bool> function)
        {
        ...
        private bool manipulate_breast_position_up_and_down_scaling()
        {
            var file_name = get_file_name();
            ...
            byte[] tag =
            {
                0x88, 0xBF, 0xE5, 0xA4, 0xA7, 0xE5, 0xB0, 0x8F,
                0x2C, 0x36, 0x30, 0x2C, 0x63, 0x66, 0x5F, 0x4A,
                0x5F, 0x4D, 0x75, 0x6E, 0x65, 0x30, 0x32, 0x5F,
                0x73, 0x5F, 0x52, 0x2C, 0x30, 0x2C, 0x30, 0x2C,
                0x30, 0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30, 0x2C,
                0x30, 0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30, 0x2C,
                0x30, 0x2C, 0x30, 0x2C, 0x38, 0x38, 0x30, 0x2C,
                0x31, 0x30, 0x34, 0x30, 0x2C, 0x38, 0x38, 0x30,
                0x2C, 0x31, 0x30, 0x34, 0x30, 0x2C, 0x38, 0x38,
                0x30, 0x2C, 0x31, 0x30, 0x34, 0x30, 0x0D, 0x0A
            };

            byte[] mask = tag;
            byte[] next =
            {
                0x37, 0x2C, 0x33, 0x2C, 0xE4, 0xB9, 0xB3, 0xE6,
                0x88, 0xBF, 0xE5, 0xB7, 0xA6, 0xE5, 0x8F, 0xB3,
                0xE5, 0xBC, 0x80, 0xE5, 0x90, 0x88, 0x2C, 0x35,
                0x30, 0x2C, 0x63, 0x66, 0x5F, 0x4A, 0x5F, 0x4D
            };
            byte[] patch_data_default =
            {
                
            };
            byte[] patch_data =
            {
                0x35, 0x2C, 0x32, 0x2C, 0xE4, 0xB9, 0xB3, 0xE6,
                ...
                0x5F, 0x4D, 0x75, 0x6E, 0x65, 0x30, 0x30, 0x5F,
                0x74, 0x5F, 0x4C, 0x2C, 0x30, 0x2C, 0x30, 0x2C,
                0x2D, 0x39, 0x39, 0x2C, 0x33, 0x32, 0x2C, 0x30,
                0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30,
                0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30,
                0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30,
                0x2C, 0x30, 0x0D, 0x0A, 0x36, 0x2C, 0x32, 0x2C,
                ...
                0x63, 0x66, 0x5F, 0x4A, 0x5F, 0x4D, 0x75, 0x6E,
                0x65, 0x30, 0x30, 0x5F, 0x74, 0x5F, 0x52, 0x2C,
                0x30, 0x2C, 0x30, 0x2C, 0x2D, 0x39, 0x39, 0x2C,
                0x33, 0x32, 0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30,
                0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30,
                0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30,
                0x2C, 0x30, 0x2C, 0x30, 0x2C, 0x30, 0x0D, 0x0A
            };
            byte[] patch = new byte[tag.Length + patch_data.Length];
            Buffer.BlockCopy(tag, 0, patch, 0, tag.Length);
            Buffer.BlockCopy(patch_data, 0, patch, tag.Length, patch_data.Length);

            var new_blob = manipulateBytes(blob, tag, mask, next, patch);
            if (new_blob == null)
            {
                error_label.Content = "ERROR: manipulation failed";
                return false;
            }
            writeSaveFile(new_blob);
            return true;
